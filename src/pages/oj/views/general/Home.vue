<template>
  <Row type="flex" justify="space-around">
    ...
    <panel shadow v-if="contests.length" class="contest">
      <div slot="title">
        <Button type="text"  class="contest-title" @click="goContest">{{contests[index].competitionTitle}}</Button>
      </div>
        ...
        <CarouselItem v-for="(contest, index) of contests" :key="index">
          <div class="contest-content">
            ...
            <div class="contest-content-description">
              <blockquote v-html="contest.competitionDescription"></blockquote>
            </div>
          </div>
        </CarouselItem>
      </Carousel>
    ...
    methods: {
      ...
      goContest () {
        this.$router.push({
          ...
          params: {contestID: this.contests[this.index].competitionId}
        })
      }
    }
  }
