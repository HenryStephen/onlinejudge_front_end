...
<!--          真实姓名-->
          <FormItem label="Real Name">
            <Input v-model="formProfile.userRealName"/>
          </FormItem>
<!--          学校-->
          <Form-item label="School">
            <Input v-model="formProfile.userSchool"/>
          </Form-item>
<!--          语言-->
          <FormItem label="Language">
            <Select v-model="formProfile.userLanguage">
...
<!--          心情-->
          <Form-item label="Mood">
            <Input v-model="formProfile.userMood"/>
          </Form-item>
<!--          博客-->
          <Form-item label="Blog">
            <Input v-model="formProfile.userBlog"/>
          </Form-item>
<!--          github-->
          <Form-item label="Github">
            <Input v-model="formProfile.userGithub"/>
          </Form-item>
        </Col>
      </Row>
    </Form>
    ...
    mounted () {
      ...
      Object.keys(this.formProfile).forEach(element => {
        if (user[element] !== undefined) {
          this.formProfile[element] = user[element]
        }
      })
    },
    methods: {
