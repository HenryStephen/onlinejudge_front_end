...
<!--    与标签有关-->
    ...
    <Panel :padding="10">
      ...
      <Button v-for="tag in tagList"
              ...
              type="ghost"
              :disabled="query.tag === tag.tagName"
              shape="circle"
      ...
      return {
        ...
        problemTableColumns: [
          ...
          // 题目难度
          {
            ...
            render: (h, params) => {
              let t = params.row.problemDifficulty
              let color = 'blue'
              ...
              }, this.$i18n.t('m.' + params.row.problemDifficulty))
            }
          },
          // 题目提交数量
          {
